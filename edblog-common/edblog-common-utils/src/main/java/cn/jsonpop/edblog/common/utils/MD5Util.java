...
import cn.jsonpop.edblog.common.base.exception.BusinessException;
...
public class MD5Util {
    ...
    public static boolean validPasswd(String passwd, String dbPasswd){
        try{
            ...
            throw new BusinessException(ResultStatus.MD5_ENCRYPT_ERRO);
        }
    }
    ...
    /*public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        String str = getEncryptedPwd("123");
